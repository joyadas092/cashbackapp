...
export const ADMIN_NAV: AdminNavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/admin/claims", icon: ReceiptText, label: "Cashback Claims" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/help-articles", icon: BookOpen, label: "Help Articles" },
      { href: "/admin/cms-pages", icon: FileText, label: "CMS Pages" },
