...
const FEATURES = [
  { icon: "🛍️", title: "Best Deals from Top Stores", body: "Flipkart, Amazon, Myntra & more" },
  { icon: "🔗", title: "Earn Extra by Sharing", body: "Turn product links into earning links" },
  { icon: "🔒", title: "Track Everything", body: "Clicks, earnings & withdrawals" },
];
